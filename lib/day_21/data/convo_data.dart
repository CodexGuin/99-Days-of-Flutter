class Convo {
  List<ConvoData> get convos => [
        ConvoData(
          ...
          chatMsg: [
            Messages(
                message: 'Did you see that game last night?',
                sender: 'Tony Ton'),
            Messages(message: 'Totally crazy!', sender: 'Me'),
            Messages(
                message: 'I know right! Best game ever.', sender: 'Tony Ton'),
          ],
        ),
        ConvoData(
        ...
        ConvoData(
          ...
          chatMsg: [
            Messages(
                message: 'Did you see the latest movie?', sender: 'James Jok'),
        ...
        ConvoData(
          ...
          chatMsg: [
            Messages(
                message: 'Remember to come home early for dinner.',
                sender: 'Dad'),
        ...
        ConvoData(
          ...
          chatMsg: [
            ...
            Messages(
                message: 'I know right! Let\'s hang out soon.', sender: 'Me'),
          ],
        ),
        ConvoData(
          convoName: 'Besties Outing!',
          ...
          chatMsg: [
            Messages(
                message: 'Guys, we need to finalize the trip!',
                sender: 'Bestie1'),
        ...
        ConvoData(
            ...
            chatMsg: [
              ...
              Messages(
                  message: 'Been a while since we talked!', sender: 'Hammy'),
